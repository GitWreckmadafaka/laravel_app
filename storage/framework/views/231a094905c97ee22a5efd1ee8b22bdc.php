            ...
            <tbody>
                <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td style="background-color: <?php echo e($color->code); ?>;"><?php echo e($color->code); ?></td>
                        <td>
                            <!-- Button to trigger modal for editing color -->
                            <button class="btn btn-warning" data-toggle="modal" data-target="#editColorModal" data-id="<?php echo e($color->id); ?>" data-name="<?php echo e($color->name); ?>" data-code="<?php echo e($color->code); ?>">Edit</button>
                            <!-- Button to trigger delete -->
                            <form action="<?php echo e(route('admin.colors.destroy', $color->id)); ?>" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this color?');">
                                <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editColorForm" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?> <!-- This will send the PUT request for updating the color -->
                        <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\LABWORKSY\resources\views/categories/createcolor.blade.php ENDPATH**/ ?>