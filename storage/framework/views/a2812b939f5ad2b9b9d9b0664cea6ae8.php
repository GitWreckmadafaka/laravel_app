...
<body>
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td>Weekly</td>
                    <td>$<?php echo e($weeklySales->total_sales ?? 0); ?></td>
                    <td><?php echo e($weeklySales->items_sold ?? 0); ?></td>
                    <td><button class="btn btn-info" onclick="fetchBreakdown('weekly')">View Breakdown</button></td>
                </tr>
                <tr>
                    <td>Monthly</td>
                    <td>$<?php echo e($monthlySales->total_sales ?? 0); ?></td>
                    <td><?php echo e($monthlySales->items_sold ?? 0); ?></td>
                    <td><button class="btn btn-info" onclick="fetchBreakdown('monthly')">View Breakdown</button></td>
                </tr>
                <tr>
                    <td>Yearly</td>
                    <td>$<?php echo e($yearlySales->total_sales ?? 0); ?></td>
                    <td><?php echo e($yearlySales->items_sold ?? 0); ?></td>
    ...
    <script>
        const weeklySales = <?php echo json_encode($weeklySales->total_sales ?? 0, 15, 512) ?>;
    const monthlySales = <?php echo json_encode($monthlySales->total_sales ?? 0, 15, 512) ?>;
    const yearlySales = <?php echo json_encode($yearlySales->total_sales ?? 0, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\LABWORKSY\resources\views/sales/index.blade.php ENDPATH**/ ?>